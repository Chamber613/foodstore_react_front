        ...
        <footer className='mt-5'>
            ...
            <div className='footer-content bg-black gap-3 px-3 px-lg-5 py-5'>
                <div className="f-content d-flex flex-wrap justify-content-space-between">
                    <div className="contacts w-20">
                        ...
                        <div className="opacity-75">
                            <div><i className="bi bi-geo-alt fd-color-primary me-2"></i></div>
                            <div><i className="bi bi-phone fd-color-primary me-2"></i>+129 97657545</div>
                            <div><i className="bi bi-envelope fd-color-primary me-2"></i>gmiller112088@gmail.com</div>
                        </div>
                        <SocialsNetworks />
                    </div>
                ...
                <div className="d-flex flex-wrap justify-content-between">
                    ...
                    <p className="opacity-75">Copyright &copy; 2022 By <span className='fw-bold'>Chamber613</span></p>
                </div>
            </div>
        </footer>
    )
