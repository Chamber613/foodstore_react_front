 ...
 export type CategoryType = {
  ...
  export const teams = [
    {team_id : 1, img : '/img/team/1.jpg', name: 'Innovative Team', role : 'Project Manager'},
    {team_id : 2, img : '/img/team/2.jpg', name: 'Innovative Team', role : 'Backend Developer'},
    {team_id : 3, img : '/img/team/3.jpg', name: 'Innovative Team', role : 'Designer'},
    {team_id : 4, img : '/img/team/4.jpg', name: 'Chamber613', role : 'Frontend Developer'}
  ]
